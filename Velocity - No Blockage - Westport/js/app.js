require([
    ...
    TileLayers = {
        1: 'https://tiles.arcgis.com/tiles/za4HjpHWqnA4SFnH/arcgis/rest/services/Westport___No_Blockage___50yr___Current_Climate___Velocity_/MapServer',
        2: 'https://tiles.arcgis.com/tiles/za4HjpHWqnA4SFnH/arcgis/rest/services/Westport___No_Blockage___50yr___SLR_0_7m___Velocity/MapServer',
        3: 'https://tiles.arcgis.com/tiles/za4HjpHWqnA4SFnH/arcgis/rest/services/Westport___No_Blockage___100yr___Current_Climate___Velocity/MapServer',
        4: 'https://tiles.arcgis.com/tiles/za4HjpHWqnA4SFnH/arcgis/rest/services/Westport___No_Blockage___100yr__SLR_0_7m___Velocity/MapServer',
        5: 'https://tiles.arcgis.com/tiles/za4HjpHWqnA4SFnH/arcgis/rest/services/Westport___No_Blockage___100yr___SLR_1m___Velocity/MapServer',
    ...
    const view = new MapView({
        ...
        xmin: 19089538.9079247, // Default to Westport area
        ymin: -5135525.179667,
        xmax: 19116216.2804426,
        ymax: -5118277.00352572
       }
    });
 ...
 //       }
   ...
   //     })
    ...
    const slabels = [
        {v: 1, label: "50yr / CC"},
        {v: 2, label: "50yr / SLR 0.7m"},
        {v: 3, label: "100yr / CC"},
        {v: 4, label: "100yr / SLR 0.7m"},
        {v: 5, label: "100yr / SLR 1m"}
        //{v: 6, label: "3m"},
       // {v: 7, label: "5m"}
    ];
